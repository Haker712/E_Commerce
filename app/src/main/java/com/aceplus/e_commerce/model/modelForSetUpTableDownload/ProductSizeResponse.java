...
public class ProductSizeResponse {
    ...
    @SerializedName("data")
    @Expose
   private ProductSizeResponseObj productSizeResponseObj;
    ...
    public ProductSizeResponseObj getProductSizeResponseObj() {
        return productSizeResponseObj;
    }

    public void setProductSizeResponseObj(ProductSizeResponseObj productSizeResponseObj) {
        this.productSizeResponseObj = productSizeResponseObj;
    }
}
